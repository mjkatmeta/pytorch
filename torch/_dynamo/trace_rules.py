...
manual_torch_name_rule_map: dict[
    ...
    "torch._functorch.vmap._add_batch_dim_in_graph": TorchInGraphFunctionVariable,
    "torch._functorch.vmap._remove_batch_dim_in_graph": TorchInGraphFunctionVariable,
    ...
    "torch._functorch.vmap._vmap_increment_nesting_in_graph": TorchInGraphFunctionVariable,
    "torch._functorch.vmap._vmap_decrement_nesting_in_graph": TorchInGraphFunctionVariable,
    # everything else
